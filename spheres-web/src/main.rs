...
fn main() {
    ...
    for mut request in server.incoming_requests() {
        ...
        let response = match (&route_method, url_path.as_str()) {
            ...
            (Method::Get, path @ ("/arcade.css" | "/arcade-operations.css" | "/arcade-discovery.css" | "/chronicle.css" | "/programs.css" | "/province-economy.css" | "/competition.css" | "/arsenal3d.css")) => {
                let css = match path {
            ...
            (Method::Get, path @ ("/chronicle-data.js" | "/chronicle-ui.js" | "/programs-ui.js" | "/province-economy-ui.js" | "/competition-ui.js" | "/arsenal-models.js" | "/arsenal3d.js")) => {
                let js = match path { "/chronicle-data.js" => CHRONICLE_DATA_JS, "/programs-ui.js" => PROGRAMS_UI_JS, "/province-economy-ui.js" => PROVINCE_ECONOMY_UI_JS, "/competition-ui.js" => COMPETITION_UI_JS, "/arsenal-models.js" => ARSENAL_MODELS_JS, "/arsenal3d.js" => ARSENAL3D_JS, _ => CHRONICLE_UI_JS };
