...
mod replenishment_view_tests {
    ...
    pub(super) fn fixture()->super::super::Game{
        ...
        g.world.resources.market=Some(spheres_sim::resources::MarketState{prices:[1000.0;12],previous_prices:[1000.0;12],cleared_volume:[0.0;12],unmet_orders:[0.0;12],fills:vec![],contract_fills:vec![],shipment_audits:vec![],contract_spend_bn:vec![],stocks:vec![spheres_sim::resources::Stock{nation:NationId::Germany,commodity:spheres_sim::resources::Commodity::Copper,quantity:10_000_000.0,reserve_target:0.0}],cash:vec![],last_produced:-1,last_cleared:-1,last_produced_day:None,last_cleared_day:None,period_days:None});
