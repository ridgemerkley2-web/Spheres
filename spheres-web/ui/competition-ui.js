...
function competitionGood(good) { return good==="advanced_components" ? "Advanced components" : good==="capital_goods" ? "Capital goods" : "Intermediate packs"; }
...
function competitionSupplyName(good) { return good==="advanced_components" ? "Advanced components" : good==="capital_goods" ? "Machinery" : good==="intermediates" ? "Materials" : String(good??"Unknown good").replace(/_/g," "); }
...
function competitionTradeHtml(data) {
  ...
  return `${competitionHero("The trading floor","Built here. Needed there.","Buy materials, machinery or available advanced components from a consenting supplier. Keep a reserve for your own projects, then offer the surplus to the world.")}
