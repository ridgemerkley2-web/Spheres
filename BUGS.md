...
**CONTINUED 2026-09-06 (D4 wired, S6-4):** the government clause of the ON half now skips `support` for the two nations whose ON-world table is the D4 block (`polity_in` differs from `polity`), coalition and pillars still compared; measured before the clause: "parted at month 0 with no stem: [rng, Nepal government, Haiti government, news [...]]"; with it the pin (month 35, Libya) and the six OFF hashes are unmoved.
...
### S4-10 — CLOSED 2026-09-06: D4 wired under the switch (P-8 closed)

**CLOSED 2026-09-06:** built as the second option, a table the OFF world cannot see (`government::polity_in`); the proof is under P-8 and S6-4.
...
### R-6 — CLOSED 2026-09-06: D4 wired under the switch (design departure 3 = S4-10 = P-8)

**CLOSED 2026-09-06:** `polity_in` serves the D4 blocks only under `rules.ideology_blocs`; both golden actuals and both digests unmoved. See P-8 and S6-4.
