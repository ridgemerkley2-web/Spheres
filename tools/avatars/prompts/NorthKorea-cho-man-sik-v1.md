# North Korea — Cho Man-sik character art v1

Prepared: 2026-09-02  
Identity source: `spheres-web/ui/portraits/NorthKorea-ada9424cc241.webp`  
...
Input images: Image 1 is the verified identity portrait of Cho Man-sik; Image 2 is the Abraham Lincoln character-art style and composition reference.

Primary request: Create one respectful full-body cartoon character of Cho Man-sik (1883–c. 1950), the nonviolent independence and civic leader selected as the historical avatar for North Korea. Preserve the recognizable facial identity and defining physical features shown in Image 1. Match Image 2's polished, slightly realistic animated-feature rendering, adult proportions, clean silhouette, soft painterly shading, restrained detail, and approachable arcade-game energy. Do not copy Abraham Lincoln's face, beard, clothing, hat, body, or pose.

Subject and clothing: Show Cho Man-sik alone in a relaxed, quietly heroic three-quarter standing pose with the entire body visible from head to footwear. Use historically and culturally appropriate documented clothing for the person's lifetime and public role. Keep props minimal and include one only when directly associated with the person's documented work. Avoid invented regalia, exoticized dress, generic stereotypes, military spectacle, and triumphalist imagery.
