# Vanuatu — Walter Lini character art v1
...
Input images: Image 1 is the Abraham Lincoln character-art style and composition reference. No freely licensed local likeness of Walter Lini was available, so this is a text-led historical interpretation.

Primary request: Create one respectful full-body cartoon character of Walter Lini (1942–1999), the priest, independence leader, and first prime minister selected as the historical avatar for Vanuatu. Make the character historically plausible and recognizably associated with Walter Lini using the supplied name, lifespan, and documented role. Match Image 1's polished, slightly realistic animated-feature rendering, adult proportions, clean silhouette, soft painterly shading, restrained detail, and approachable arcade-game energy. Do not copy Abraham Lincoln's face, beard, clothing, hat, body, or pose.

Subject and clothing: Show Walter Lini alone in a relaxed, quietly heroic three-quarter standing pose with the entire body visible from head to footwear. Use historically and culturally appropriate documented clothing for the person's lifetime and public role. Keep props minimal and include one only when directly associated with the person's documented work. Avoid invented regalia, exoticized dress, generic stereotypes, military spectacle, and triumphalist imagery.
