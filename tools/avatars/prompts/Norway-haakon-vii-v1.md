# Norway — Haakon VII character art v1
...
Input images: Image 1 is the Abraham Lincoln character-art style and composition reference. No freely licensed local likeness of Haakon VII was available, so this is a text-led historical interpretation.

Primary request: Create one respectful full-body cartoon character of Haakon VII (1872–1957), the constitutional monarch and wartime resistance symbol selected as the historical avatar for Norway. Make the character historically plausible and recognizably associated with Haakon VII using the supplied name, lifespan, and documented role. Match Image 1's polished, slightly realistic animated-feature rendering, adult proportions, clean silhouette, soft painterly shading, restrained detail, and approachable arcade-game energy. Do not copy Abraham Lincoln's face, beard, clothing, hat, body, or pose.

Subject and clothing: Show Haakon VII alone in a relaxed, quietly heroic three-quarter standing pose with the entire body visible from head to footwear. Use historically and culturally appropriate documented clothing for the person's lifetime and public role. Keep props minimal and include one only when directly associated with the person's documented work. Avoid invented regalia, exoticized dress, generic stereotypes, military spectacle, and triumphalist imagery.
