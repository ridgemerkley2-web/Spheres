...
class TongaTransitionTests(unittest.TestCase):
    ...
    def test_no_second_prime_minister_institution(self):
        ...
        # CLAUDE-C01-08 added exactly seven 1990-2018 holders ahead of the 2019 and 2021 ones, and CLAUDE-C01-03
        # appended the 2025 appointment event; still one office and one head-of-government role.
        self.assertEqual([h['name'] for h in holders if isinstance(h, dict)],
                         ["Fatafehi Tu'ipelehake", 'Baron Vaea', "Prince 'Ulukalala Lavaka Ata", 'Feleti Sevele',
                          ...
                          "Pohiva Tu'i'onetoa", SOVALENI, "'Aisake Valu Eke"])
