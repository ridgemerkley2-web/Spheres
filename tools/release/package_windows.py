...
def main():
    ...
    for name in ['README.md','CURRENT_ARCHITECTURE.md','DECISIONS.md','PLAYTEST.md','PLAYER_DECISIONS.md','MILITARY_OPERATIONS.md','CAMPAIGN_AIMS.md','SECTOR_PROFILES.md','TECH_REFERENCE_REPAIR.md','INVESTMENT_COMPLETION_AUDIT.md']:
        source=ROOT/name
