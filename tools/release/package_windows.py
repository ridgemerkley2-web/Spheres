...
release folders are refused; choose a new output root when making a new build.
"""
...
def main():
    ...
    release=args.output/'SPHERES-0.6-Windows'
    ...
    for name in ['README.md','CURRENT_ARCHITECTURE.md','DECISIONS.md','PLAYTEST.md','PLAYER_DECISIONS.md','MILITARY_OPERATIONS.md','CAMPAIGN_AIMS.md','SECTOR_PROFILES.md','TECH_REFERENCE_REPAIR.md','HEADLESS_BASELINE_2026-09-04.md','DAILY_CALIBRATION.md','PERFORMANCE.md','INVESTMENT_COMPLETION_AUDIT.md']:
        source=ROOT/name
