...
Retirement has no cash or material refund and cannot be undone within the game. It reduces the physical fleet's future maintenance need, while existing budget allocations and already-recorded payments stay unchanged. The comparison holds recorded support fixed; normal settlement recalculates support later. Retirement introduces no new saved fields or save-version change.
