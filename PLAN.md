...
**Character direction update:** the user approved fixed cartoons and extended the worldwide request through 2035. Historical and fictional cartoons are registered separately, with current counts in the production inventory. Real sourced history ends on 7 September 2026; fictional candidates can enter actual campaign succession from 8 September 2026 through 2035. The calendar never replaces incumbents. Global research and artwork remain unfinished. [The cartoon roadmap](docs/CARTOON_CHARACTER_ROADMAP.md) is the current production plan, with a separate [production inventory](docs/LEADERSHIP_PRODUCTION_2035.md).

The user chose real people through the present source cutoff, followed by research-informed fictional successors. The catalog separates immutable people, party roles, dated affiliations, campaign officeholders and original future identities. Historical term endings never change governments by calendar. Small parties, composite rows and collective leadership are included, with explicit gaps. Broad institutional future profiles are implemented; country-specific editorial research remains incomplete.
...
The Government Leadership page supports campaign/reference modes, exact dates and 1990–2026 year selection, sources, fixed cartoon avatars and separate component leaders. Missing artwork remains explicit; no national-symbol image substitutes for a historical person. Previous physical models remain archived. Current measured historical coverage is documented in [the leadership roadmap](docs/PARTY_LEADERSHIP_ROADMAP.md).
...
then deliver into the existing ammunition magazine. Supply conversion retains
public batches and reserve preferences while stopping future automatic public
batches for that family. Standing government purchases remain future work.
