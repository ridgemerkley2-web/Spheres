//! Government â€” parties, elections, coalitions, and the regimes that hold power
//! without any of them.
//!
...
//! as one of the five things this game replaces â€” with "political capital as a
...
//! from the institutions that could remove you â€” the army, the party apparatus,
//! the security services, the merchants, the clergy â€” and a coup when the buying
...
pub enum Family {
    ...
    Religious,
    Agrarian,
    /// A party that is a coalition in itself â€” Congress, the PMDB, Solidarity,
...
pub struct PartySpec {
    ...
    pub start: f64,
    /// Nobody will sit in cabinet with them. A real institution of this period â€”
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub enum Electoral {
    /// Single-member plurality. Roughly obeys the cube law â€” a party with 55% of
    /// the two-party vote takes about 63% of the seats â€” so majorities are
    ...
    Proportional,
    /// Proportional with a 10% threshold â€” Turkey's, the highest in Europe, put
    /// in place by the 1982 constitution to keep small parties out.
    ProportionalHighBar,
    /// Proportional with a 1% threshold â€” Israel's until 1992, which is why the
...
/// is not a thing that removes a government â€” the Republican Guard is.
...
pub struct Polity {
    ...
    /// (0, 0) means the regime does not hold them â€” until it liberalises, at
...
/// which a president dismissed in August 1990 â€” the model reaches that through
...
pub const POLITIES: &[Polity] = &[
    // United States â€” 1988 House of Representatives popular vote: Democrats
    ...
    // Soviet Union â€” Article 6 of the 1977 constitution still gave the CPSU its
    ...
    // Russia â€” 1993 State Duma party-list vote: LDPR 22.9%, Russia's Choice
    ...
    // Ukraine â€” 1998 Verkhovna Rada party-list vote: CPU 24.7%, Rukh 9.4%,
    ...
    // China â€” the Communist Party of China, eight months after Tiananmen. The
    ...
    // Japan â€” House of Representatives, 6 July 1986: LDP 49.4%, JSP 17.2%,
    ...
    // Germany â€” Bundestag, 25 January 1987 (Federal Republic): CDU/CSU 44.3%,
    ...
    // United Kingdom â€” general election of 11 June 1987: Conservative 42.2%,
    ...
    // France â€” National Assembly first round, 5 June 1988: PS 34.8%, RPR 19.2%,
    ...
    // Italy â€” Chamber of Deputies, 14 June 1987: DC 34.3%, PCI 26.6%, PSI 14.3%,
    ...
    Polity {
        ...
        // vote. That is not a detail â€” it is the reason a government needed five
    ...
    // India â€” 9th Lok Sabha, November 1989: Congress(I) 39.5%, Janata Dal 17.8%,
    ...
    // Pakistan â€” National Assembly, 16 November 1988: PPP 38.5%, the Islami
    ...
    // Iraq â€” the Arab Socialist Ba'ath Party, and behind it the three
    ...
    // Kuwait â€” the Emir dissolved the National Assembly in 1986 and ruled by
    ...
    // Saudi Arabia â€” no parties, no assembly at all until the Consultative
    ...
    // Iran â€” the Islamic Republic eighteen months after Khomeini's death. The
    ...
    // South Korea â€” National Assembly, 26 April 1988: DJP 34.0%, RDP 23.8%, PPD
    ...
    // Democratic Liberal Party â€” a coalition by another name, which is what this
    ...
    // Poland â€” the semi-free election of 4 June 1989, in which Solidarity's
    ...
    // Brazil â€” Chamber of Deputies, 15 November 1986: PMDB 48.1%, PFL 17.7%,
    ...
    // Indonesia â€” the New Order permitted three organisations and no more.
    ...
    // Egypt â€” People's Assembly, 6 April 1987: NDP 69.6%, the Islamic Alliance
    ...
    // Spain â€” Congress of Deputies, 29 October 1989: PSOE 39.6%, PP 25.8%,
    ...
    // Netherlands â€” Tweede Kamer, 6 September 1989: CDA 35.3%, PvdA 31.9%,
    ...
    // threshold is one seat in a single national district â€” 0.67% â€” so the low
    ...
    // Belgium â€” Chamber of Representatives, 13 December 1987: CVP 19.5%,
    ...
    // Sweden â€” Riksdag, 18 September 1988: SAP 43.2%, Moderates 18.3%,
    ...
    // Switzerland â€” National Council, 18 October 1987: FDP 22.9%, CVP 19.6%,
    ...
    // Austria â€” Nationalrat, 23 November 1986: SPO 43.1%, OVP 41.3%, FPO 9.7%,
    ...
    // Portugal â€” Assembly of the Republic, 19 July 1987: PSD 50.2%, PS 22.2%,
    ...
    // Greece â€” Hellenic Parliament, 5 November 1989: New Democracy 46.2%,
    ...
    // Denmark â€” Folketing, 10 May 1988: Social Democrats 29.8%, Conservatives
    ...
    // than communist â€” it split from the DKP in 1959 â€” but the leftmost family
    ...
    // Norway â€” Storting, 11 September 1989: Labour 34.3%, Conservatives 22.2%,
    ...
    // Finland â€” Eduskunta, 15-16 March 1987: SDP 24.1%, National Coalition
    ...
    // Ireland â€” Dail Eireann, 15 June 1989: Fianna Fail 44.1%, Fine Gael 29.3%,
    ...
    // Czechoslovakia â€” the last election before the game opens is the National
    ...
    // constitution â€” it never agreed one, and the state dissolved instead.
    Polity {
    ...
    // East Germany â€” Volkskammer, 18 March 1990, the only free election the GDR
    ...
    // Hungary â€” National Assembly, 25 March and 8 April 1990, party lists:
    ...
    // Romania â€” Chamber of Deputies, 20 May 1990: FSN 66.3%, UDMR 7.2%, PNL
    ...
    // Bulgaria â€” Grand National Assembly, 10 and 17 June 1990, proportional
    ...
    // Albania â€” the People's Assembly election of 1 February 1987 returned the
    ...
    // Argentina â€” Chamber of Deputies, 14 May 1989, held with the presidential
    ...
    // Mexico â€” Chamber of Deputies, 6 July 1988: PRI 51.1%, the Cardenista
    ...
    // its founding in 1929 and does not lose one until 2000 â€” which the model
    ...
    // Chile â€” Chamber of Deputies, 14 December 1989, the first since 1973, held
    ...
    // Colombia â€” Chamber of Representatives, 9 March 1986: Liberals 48.6%,
    ...
    // Venezuela â€” Chamber of Deputies, 4 December 1988: AD 43.3%, COPEI 31.1%,
    ...
    // Peru â€” Chamber of Deputies, 14 April 1985: APRA 50.1%, Izquierda Unida
    ...
    // uses elsewhere â€” enter a party founded after the last election at its
    // first contested share, as Colombia's AD M-19 is entered â€” cannot be
    ...
    // Cuba â€” one legal party since 1965, and no national election a voter could
    ...
    // Castro, the party apparatus, and the Ministry of the Interior â€” and in
    ...
    // Bolivia â€” general election, 7 May 1989: MNR 25.7%, ADN 25.2%, MIR 21.8%,
    ...
    // Patriotico with Hugo Banzer's ADN â€” the general who had jailed and exiled
    ...
    // Ecuador â€” congressional election of 31 January 1988, held with the
    ...
    // Uruguay â€” general election, 26 November 1989: the National Party 38.9%,
    ...
    // Syria â€” People's Council, 10-11 February 1986. The National Progressive
    ...
    // Jordan â€” House of Representatives, 8 November 1989: the first election in
    ...
    // Lebanon â€” the last parliamentary election was in April 1972. The Chamber
    ...
    // first election either contested â€” 8 seats of 128 each, in August-September
    // 1992 â€” under the convention this table already uses elsewhere. The Taif
    ...
    // United Arab Emirates â€” a federation of seven hereditary monarchies whose
    ...
    // Qatar â€” no elections of any kind. The Advisory Council created in 1972 was
    ...
    // Oman â€” Sultan Qaboos bin Said ruled by decree, holding the offices of prime
    ...
    // Yemen â€” the transitional House of Representatives of the unified republic,
    ...
    // Bahrain â€” the last election was on 7 December 1973, for the National
    ...
    // Algeria â€” the last *national* vote before the game opens is the People's
    ...
    // Morocco â€” Chamber of Representatives, 14 September 1984: Constitutional
    ...
    // Tunisia â€” Chamber of Deputies, 2 April 1989: the RCD took 80.4% of the
    ...
    // Libya â€” no parties and no election of any kind, ever. Law 71 of 1972 made
    ...
    // Sudan â€” National Assembly, 1-12 April 1986: the Umma Party 100 seats, the
    ...
    // South Africa â€” House of Assembly, 6 September 1989, the last election held
    ...
    // than a democracy â€” the tricameral coloured and Indian chambers were
    ...
    // Ethiopia â€” the Workers' Party of Ethiopia, sole legal party under the 1987
    ...
    // Kenya â€” National Assembly, 21 March 1988, the mlolongo election: voters
    ...
    // Ghana â€” the Provisional National Defence Council, ruling by decree since
    ...
    // Zaire â€” the Popular Movement of the Revolution, to which every citizen
    ...
    // Angola â€” the MPLA-Workers' Party, sole legal party and still explicitly
    ...
    // Zimbabwe â€” the general election of 28-30 March 1990, the first after the
    ...
    // Tanzania â€” the general election of 27 October 1985, held under Article 3
    ...
    // Uganda â€” no national election since December 1980, the disputed vote that
    ...
    // Senegal â€” National Assembly, 28 February 1988: Abdou Diouf's Socialist
    ...
    // Cote d'Ivoire â€” National Assembly, 10 November 1985, a single PDCI list
    ...
    // Cameroon â€” National Assembly, 24 April 1988, a single CPDM list; Biya had
    ...
    // Bangladesh â€” the last national election before January 1990 was the
    ...
    // transcribed here are therefore the first free one, 27 February 1991 â€”
    // BNP 30.81%, Awami League 30.08%, Jamaat-e-Islami 12.13%, Jatiya Party
    // 11.92% â€” which is the vote this table exists to represent, because
    ...
    // Sri Lanka â€” Parliament, 15 February 1989: UNP 50.71%, SLFP 31.90%, EROS
    ...
    // Nepal â€” an absolute monarchy in January 1990. The partyless Panchayat
    ...
    // Afghanistan â€” the People's Democratic Party of Afghanistan, renamed the
    ...
    // Myanmar â€” the State Law and Order Restoration Council, the junta General
    ...
    // North Korea â€” the Workers' Party of Korea. The Supreme People's Assembly
    ...
    // Taiwan â€” the supplementary Legislative Yuan election of 2 December 1989,
    ...
    // Thailand â€” House of Representatives, 24 July 1988, the election that made
    ...
    // Malaysia â€” general election of 3 August 1986: Barisan Nasional 55.8%,
    ...
    // nine months away, on 21 October 1990 â€” the one Tengku Razaleigh contested
    ...
    // Singapore â€” general election of 3 September 1988, the first fought on
    ...
    // Philippines â€” House of Representatives, 11 May 1987, the first under the
    ...
    // vote for that election â€” it was contested by personal coalitions that
    ...
    // Cambodia â€” the State of Cambodia, governed by the Kampuchean People's
    ...
    // Laos â€” the Lao People's Revolutionary Party, in power since December 1975
    ...
    // Mongolia â€” the Mongolian People's Revolutionary Party, whose monopoly under
    ...
    // Canada â€” House of Commons, 21 November 1988, the free-trade election:
    ...
    // 25 October 1993 â€” the one that reduced the governing party to two seats.
    Polity {
    ...
    // Australia â€” House of Representatives, 11 July 1987, first-preference vote:
    ...
    // it is entered as TwoRound rather than plurality â€” a seat is not won on a
    ...
    // New Zealand â€” House of Representatives, 15 August 1987: Labour 48.0%,
    ...
    // single-member seats on a three-year term â€” the two-party system that
    ...
    // Israel â€” Knesset, 1 November 1988: Likud 31.1%, the Alignment 30.0%, Shas
    ...
    // confidence â€” the only one ever carried in Israeli history â€” and that is
    ...
    // Turkey â€” Grand National Assembly, 29 November 1987: ANAP 36.3%, SHP 24.7%,
    ...
    // Nigeria â€” Babangida's Armed Forces Ruling Council, five years into a
    ...
    // Vietnam â€” the Communist Party of Vietnam, four years into doi moi and the
    ...
    // Yugoslavia â€” the League of Communists of Yugoslavia, whose 14th
    ...
    // Serbia â€” 9 December 1990, the first multiparty election in Serbia since
    ...
    // Croatia â€” 22 April 1990: Tudjman's Croatian Democratic Union 41.9%, the
    ...
    // Slovenia â€” 8 April 1990: the DEMOS opposition coalition 54.0%, the Party
    ...
    // Bosnia and Herzegovina â€” 18 November 1990. The three national parties took
...
/// equilibrium at all â€” an incumbent with a good record gains a little every
...
impl GovState {
    ...
    /// The least contented institution of any kind â€” what a briefing shows.
...
/// seats. If it cannot get there, it governs as a minority â€” which is a real
...
fn form_government(w: &mut WorldState, id: NationId, announce: bool) {
    ...
    // A pariah party that wins outright still governs â€” the cordon holds against
...
fn drift_support(w: &mut WorldState, id: NationId) {
    ...
    // long as the economy was fine â€” and it was why an incumbent's support crept
...
/// three again, with the failures moving around between runs of a tuning pass â€”
...
/// share on the way in â€” the wasted-vote psychology Duverger named â€” but
...
pub fn standing_modifier(w: &WorldState, id: NationId) -> f64 {
    ...
    // what a war costs a government at home â€” `a_war_costs_a_government_at_home`
    ...
    if is_electoral(w, id) {
        ...
        // did â€” that one cancelled a third of what a war costs at home.
        ...
        // is paying all of its institutions is merely solvent â€” that is the zero
        // â€” and one that has stopped paying bleeds standing that nothing it
...
pub fn secure_pillar(w: &mut WorldState, id: NationId, pillar: Pillar) -> Result<(), String> {
    ...
    // ratcheted defence budgets upward for a century â€” Kuwait's peacetime army
...
fn regime_tick(w: &mut WorldState, id: NationId) {
    ...
    for pillar in pillars {
        let t = match pillar {
            ...
            // at 0.357 â€” a hair above the 0.35 line at which pressure starts to
            ...
            // The apparatus is loyal because it *is* the regime â€” it has nowhere
            // else to go â€” so its floor rises with how authoritarian the state
...
fn maybe_coup(w: &mut WorldState, id: NationId) {
    ...
    // in about a year. No die is thrown â€” see `hold_election` for why.
...
fn ai_government(w: &mut WorldState) {
    ...
    for id in ids {
        ...
        if let Some((pillar, loyalty)) = weak {
            ...
            // and it quietly bankrupted the Soviet Union's foreign policy â€”
...
mod tests {
    ...
    fn party_support_moves_with_prices_rather_than_with_a_slider() {
        ...
        // support â€” and it loses it to the family whose whole argument is sound
    ...
    fn opening_up_a_regime_produces_an_election_without_anything_scheduling_one() {
        ...
        // No date, no country name â€” only the authoritarianism falling.
        let mut w = w1990();
        w.rules.ai_aggression = 0.0;
