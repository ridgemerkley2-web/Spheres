...
pub enum NationId {
    ...
    Portugal, Greece, Denmark, Norway, Finland, Ireland,
    Czechoslovakia, Hungary, Romania, Bulgaria, Albania, EastGermany,
    Belarus, Kazakhstan, Uzbekistan, Georgia, Armenia, Azerbaijan,
    Lithuania, Latvia, Estonia, Moldova, Argentina, Mexico,
    Chile, Colombia, Venezuela, Peru, Cuba, Bolivia,
    Ecuador, Uruguay, Syria, Jordan, Lebanon, UAE,
    Qatar, Oman, Yemen, Bahrain, Algeria, Morocco,
    Tunisia, Libya, Sudan, SouthAfrica, Ethiopia, Kenya,
    Ghana, Zaire, Angola, Zimbabwe, Tanzania, Uganda,
    Senegal, CoteDIvoire, Cameroon, Bangladesh, SriLanka, Nepal,
    Afghanistan, Myanmar, NorthKorea, Taiwan, Thailand, Malaysia,
    Singapore, Philippines, Cambodia, Laos, Mongolia, Canada,
...
pub const SUCCESSOR_NATIONS: [NationId; 16] = [
    ...
    NationId::Belarus, NationId::Kazakhstan, NationId::Uzbekistan, NationId::Georgia,
    NationId::Armenia, NationId::Azerbaijan, NationId::Lithuania, NationId::Latvia,
    NationId::Estonia, NationId::Moldova,
];
...
impl NationId {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            NationId::Spain => "Spain",
            NationId::Netherlands => "Netherlands",
            NationId::Belgium => "Belgium",
            NationId::Sweden => "Sweden",
            NationId::Switzerland => "Switzerland",
            NationId::Austria => "Austria",
            NationId::Portugal => "Portugal",
            NationId::Greece => "Greece",
            NationId::Denmark => "Denmark",
            ...
            NationId::Algeria => "Algeria",
            NationId::Morocco => "Morocco",
            NationId::Tunisia => "Tunisia",
            NationId::Libya => "Libya",
            NationId::Sudan => "Sudan",
    ...
    pub fn parse(s: &str) -> Option<NationId> {
        ...
        Some(match t.as_str() {
            ...
            "spain" | "esp" => NationId::Spain,
            "netherlands" | "the netherlands" | "holland" | "nld" => NationId::Netherlands,
            "belgium" | "bel" => NationId::Belgium,
            "sweden" | "swe" => NationId::Sweden,
            "switzerland" | "swiss" | "che" => NationId::Switzerland,
            "austria" | "aut" => NationId::Austria,
            "portugal" | "prt" | "por" => NationId::Portugal,
            "greece" | "hellas" | "grc" => NationId::Greece,
            "denmark" | "dnk" | "den" => NationId::Denmark,
            ...
            "algeria" | "dza" | "alg" => NationId::Algeria,
            "morocco" | "mar" | "maroc" => NationId::Morocco,
            "tunisia" | "tun" | "tunisie" => NationId::Tunisia,
            "libya" | "lby" | "jamahiriya" => NationId::Libya,
            "sudan" | "sdn" | "the sudan" => NationId::Sudan,
...
pub const ALL_NATION_IDS: [NationId; NATION_COUNT] = [
    ...
    NationId::Finland, NationId::Ireland, NationId::Czechoslovakia, NationId::Hungary,
    NationId::Romania, NationId::Bulgaria, NationId::Albania, NationId::EastGermany,
    NationId::Belarus, NationId::Kazakhstan, NationId::Uzbekistan, NationId::Georgia,
    NationId::Armenia, NationId::Azerbaijan, NationId::Lithuania, NationId::Latvia,
    NationId::Estonia, NationId::Moldova, NationId::Argentina, NationId::Mexico,
    NationId::Chile, NationId::Colombia, NationId::Venezuela, NationId::Peru,
    NationId::Cuba, NationId::Bolivia, NationId::Ecuador, NationId::Uruguay,
    NationId::Syria, NationId::Jordan, NationId::Lebanon, NationId::UAE,
    NationId::Qatar, NationId::Oman, NationId::Yemen, NationId::Bahrain,
