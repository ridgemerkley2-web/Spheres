...
pub fn arms_at(w: &WorldState, n: &Nation, ministry: usize, allocation: f64) -> Vec<Arm> {
    ...
    match ministry {
        ...
        BUDGET_EDUCATION if crate::population::active(w) => vec![Arm {
        ...
        BUDGET_PENSIONS => vec![
            ...
            Arm {
                id: "jobs",
                name: if crate::population::active(w) { "Workforce participation target" } else { "Unemployment" },
                ...
                // reader to add them.
                kind: ArmKind::Share,
                value: if crate::population::active(w) {
