...
Candidate: `bcdf72bcbe8947966359deb95f715cb526a68def`. Windows executable SHA-256:
`01139a2921f3357eefa4242530a1c52fc0a0d090d4fcaf76317c50e3189ccbdf`.

The complete game source matches `0f4616477671bc01936fcc9f2877ae172b13e348` exactly. The new executable embeds the current
...
| Windows agency/succession | 12 passed; 0 ignored |
| Windows party leadership | 49 passed; 0 ignored |
| Windows interface | 1565 passed; 1 skipped |
| Linux native web | 387 passed; 16 ignored |
| Linux agency/succession | 12 passed; 0 ignored |
| Linux party leadership | 49 passed; 0 ignored |
| Linux interface | 1565 passed; 1 skipped |
| Content | 102 tests; five reproduction checks |
...
[inventory](evidence/inventory.json) retains 328 logical
files and 210,960,458 stored bytes, excluding itself. Large
