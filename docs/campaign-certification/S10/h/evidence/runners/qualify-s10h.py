...
PIN=sys.argv[1]
OUT=BASE/'evidence/S10h-qualified'
...
proof={'format':'spheres-s10h-qualification/v1','source_revision':PIN,'source_clean_before':True,'started_utc':datetime.datetime.now(datetime.timezone.utc).isoformat(),'runner_sha256':sha(pathlib.Path(__file__)),
