...
out=base/'evidence/S10g-content-final';out.mkdir(exist_ok=False)
commands={
 'tonga-tests':['python','-X','utf8','-m','unittest','discover','-s','tools/avatars','-p','test_tonga_research_s10g.py'],
 'brazil-tests':['python','-X','utf8','-m','unittest','discover','-s','tools/avatars','-p','test_brazil_research_s10f.py'],
 'india-tests':['python', '-X', 'utf8', '-m', 'unittest', 'discover', '-s', 'tools/avatars', '-p', 'test_india_research_s10e.py'],
