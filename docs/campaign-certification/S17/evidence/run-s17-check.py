"""Source-pinned S17 qualification; new logs only, no repository mutation."""
...
if lane=='browser':
    env.update(SPHERES_BINARY=str(exe),SPHERES_EXPECTED_REVISION=pin,SPHERES_BROWSER_CHANNEL='chrome',SPHERES_S17_BROWSER_OUTPUT=str(base/'evidence'/('S17-browser-'+label)))
