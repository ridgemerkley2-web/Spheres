...
stem=base/'evidence'/('S09-final-'+label)
...
commands={
 ...
 'research-browser':['node','tools/ui/ci-research-design.cjs'],
...
if lane.startswith('browser') or lane in ('money-browser','construction-browser','supplier-browser','research-browser'):
...
if lane=='research-browser': env['SPHERES_RESEARCH_OUTPUT']=str(base/'evidence'/('S09-browser-'+label))
command=commands[lane]
browser_lane=lane.startswith('browser') or lane in ('money-browser','construction-browser','supplier-browser','research-browser')
...
elif lane=='binary' or lane.startswith('browser') or lane in ('money-browser','construction-browser','supplier-browser','research-browser'): binary=base/'integration-target/release/spheres-web.exe'
else: binary=None
