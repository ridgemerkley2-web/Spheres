...
const {chromium}=require(require.resolve('playwright',{paths:["C:\\Users\\ridge\\Documents\\Codex\\2026-09-05\\pick-up-the-spheres-game-on\\work\\campaign-certification\\integration\\tools\\ui"]})),integrated=require("C:\\Users\\ridge\\Documents\\Codex\\2026-09-05\\pick-up-the-spheres-game-on\\work\\campaign-certification\\integration\\tools\\ui\\ci-integrated.cjs"),audit=require("C:\\Users\\ridge\\Documents\\Codex\\2026-09-05\\pick-up-the-spheres-game-on\\work\\campaign-certification\\integration\\tools\\ui\\supplier-archive-audit.cjs");
const root="C:\\Users\\ridge\\Documents\\Codex\\2026-09-05\\pick-up-the-spheres-game-on\\work\\campaign-certification\\integration",q=x=>JSON.stringify(String(x)),copy=x=>JSON.parse(JSON.stringify(x));
...
calendar={k:w[k] for k in ['year','month','day']};assert all(isinstance(v,int) for v in calendar.values())
as_of_day=(datetime.date(w['year'],w['month'],max(1,w['day']))-datetime.date(1990,1,1)).days
