...
out = base / 'evidence/S21-final4-linux'
out.mkdir(exist_ok=False)
env = dict(os.environ)
shim=pathlib.Path('/home/ridge/.cache/spheres-s21-git')
shim.mkdir(exist_ok=True)
shimfile=shim/'git'
shimfile.write_text('#!/bin/sh\nexec env -u GIT_DIR -u GIT_WORK_TREE "/mnt/c/Program Files/Git/cmd/git.exe" -C "C:/Users/ridge/Documents/Codex/2026-09-05/pick-up-the-spheres-game-on/work/campaign-certification/integration" "$@"\n')
shimfile.chmod(0o755)
...
record = {
    'format': 'spheres-s21-linux/v1', 'revision': pin, 'started_utc': stamp(), 'status': 'running',
    'scope': 'S21 final native web and full simulation library qualification after first-day dissolution leadership repair. Authored boundary scenarios do not establish a full elapsed 1990-2035 campaign. Node evidence is inherited from unchanged UI/unit-test sources at 5b92fbb.',
