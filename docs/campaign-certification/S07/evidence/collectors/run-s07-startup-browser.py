"""Run an ignored startup-only candidate against the exact clean S07 binary.

Usage: python run-s07-startup-browser.py PIN {tonga,browser} UNIQUE_STEM
...
if lane == 'tonga':
    output = repo / 'artifacts/s07-startup-harness' / (label + '-construction')
