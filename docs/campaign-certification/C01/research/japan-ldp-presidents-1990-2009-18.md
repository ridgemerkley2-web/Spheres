...
election won by 谷垣禎一, and adds 81 sources, 192 claims and fourteen holder observations, placed before the unchanged 2024 and
...
| 8 Sep 2009 | election schedule approved (麻生太郎); prospective resignation statement (麻生太郎); in office (continuation) (麻生太郎) | `jp_ldp_2009_election_schedule_approved_joint_plenary_20090908`, `jp_ldp_aso_states_will_resign_presidency_with_cabinet_20090908`, `jp_ldp_aso_president_addresses_joint_plenary_20090908` |
...
(`jp_ldp_diet_hashimoto_chosen_at_convention_19950925`, a selection dated by the day it states, never a start). The party history
says 橋本龍太郎総裁 announced his resignation after the July 1998 upper-house election, without a day
(`jp_ldphist_hashimoto_resignation_announced_1998`, retrospective, never an end). On 24 July 1998 the party's captions show 橋本総裁
greeting the joint plenary meeting before the vote (`jp_ldp98p1_hashimoto_greets_joint_plenary_19980724`) and, after the decision,
橋本前総裁 (`jp_ldp98p3_hashimoto_called_former_president_19980724`).
...
September 2012, and the era page records the election, 谷垣氏's 就任 and 麻生総裁's stepping down as three undated retrospective
claims (`jp_ldp_history_tanigaki_era_election_narrative`, `jp_ldp_tanigaki_era_assumption_reference`,
`jp_ldp_tanigaki_era_aso_stepped_down_reference`).
...
- `research-index.json` is regenerated in a **separate commit** and is the only file shared with other pending packets (the India,
  ...
  sources and 688 claims (CLAUDE-C01-13: 337 and 496); institutions, roles (5), `mapping_pending` (24) and the Japan work orders
  (10, 10 and 4 members) are unchanged.
- Pinned tests, none loosened and no assertion removed:
  - `test_japan_research_s10d.py`: counts (entries, sources, claims, roles) are now (24, 418, 688, 5), with this packet's 81 sources
    and 192 claims pinned beside CLAUDE-C01-12's and CLAUDE-C01-13's; the party holders' count is 19 and the guard that no party
