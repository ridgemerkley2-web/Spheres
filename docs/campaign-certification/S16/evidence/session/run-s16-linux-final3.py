...
out = base / 'evidence/S16-final3-linux'
...
record = {
    'format': 'spheres-s16-linux/v1', 'revision': pin, 'started_utc': stamp(), 'status': 'running',
    'scope': 'Full native simulation library, web and Node suites, plus thirteen ground/shared-force/supply/refit integration targets on Linux. No external old-save, elapsed campaign, exhaustive historical-content or gate-completion claim.',
...
try:
    ...
    commands = [
        ...
        ('integration', ['cargo', 'test', '--locked', '--release', '-p', 'spheres-sim', '--test', 'ground_equipment_integration', '--test', 'military_operations', '--test', 'campaign_operations', '--test', 'equipment_integration', '--test', 'company_refits', '--test', 'equipment_supply_automation', '--test', 'company_ammunition', '--test', 'ammunition_reserves', '--test', 'aviation_ammunition', '--test', 'campaign_movement_audit', '--test', 'campaign_peace_audit', '--test', 'companies_integration', '--test', 's08_supplier_lifecycle', '--no-fail-fast']),
