...
commands=[('root-sim',['cargo','test','--locked','--release','-p','spheres-sim','--lib','s08_','--','--nocapture','--test-threads=1']),('route-context',['cargo','test','--locked','--release','-p','spheres-sim','--lib','contract_forecast_context','--','--nocapture','--test-threads=1']),('market-cargo',['cargo','test','--locked','--release','-p','spheres-sim','--lib','spot_opening_pending','--','--nocapture','--test-threads=1']),('new-inbound',['cargo','test','--locked','--release','-p','spheres-sim','--lib','new_inbound_commodity_short_circuit','--','--nocapture','--test-threads=1']),('route-access',['cargo','test','--locked','--release','-p','spheres-sim','--lib','freight_access_read','--','--nocapture','--test-threads=1']),('clearing-access',['cargo','test','--locked','--release','-p','spheres-sim','--lib','clearing_access_reuse','--','--nocapture','--test-threads=1']),('commerce',['cargo','test','--locked','--release','-p','spheres-sim','--lib','commerce_','--','--nocapture','--test-threads=1']),('ai-observer',['cargo','test','--locked','--release','-p','spheres-sim','--lib','detailed_review_observer','--','--nocapture','--test-threads=1']),('web-reads',['cargo','test','--locked','--release','-p','spheres-web','s08_','--','--nocapture','--test-threads=1'])]
commands.append(('civilian-gap',['cargo','test','--locked','--release','-p','spheres-sim','--lib','resources::tests::expiring_authority_sizes_a_civilian_contract_from_civilian_work_only','--','--exact','--nocapture','--test-threads=1']))
commands.append(('gdp-accounting',['cargo','test','--locked','--release','-p','spheres-sim','--lib','gdp_projects::tests::','--','--nocapture','--test-threads=1']))
commands.append(('all-routing',['cargo','test','--locked','--release','-p','spheres-sim','--lib','logistics::','--','--nocapture','--test-threads=1']))
commands.append(('equipment-supply',['cargo','test','--locked','--release','-p','spheres-sim','--lib','equipment::supply_tests::','--','--nocapture','--test-threads=1']))
