...
out=source.parent/'evidence/S05-linux-candidate-2'
pin='8c9159786d3736a9953706262a52c50898225f0e'
...
def run(name,args,extra=None):
 ...
 return result
try:
 record['source_before']=snapshot('source-before.json');record['fixtures_before']=fixture_snapshot('fixtures-before.json')
