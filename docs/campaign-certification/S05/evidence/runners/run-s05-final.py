...
stem=base/'evidence'/('S05-final-'+(sys.argv[3] if len(sys.argv)>3 else lane))
...
elif lane=='binary' or lane.startswith('browser'): binary=base/'integration-target/release/spheres-web.exe'
else: binary=None
