...
root=pathlib.Path(__file__).resolve().parent;repo=root/'integration';e=root/'evidence/S05-external-runtime-final';e.mkdir(exist_ok=False)
rev=subprocess.check_output(['git','rev-parse','HEAD'],cwd=repo,text=True).strip();assert rev=='db9d17c8d726aa102aa143ceb3599009c558ffee'
