"""Receipt the parent's completed checkpoint25 workspace build; never builds/runs binaries."""
import argparse, importlib.util, json, pathlib, re

HERE = pathlib.Path(__file__).resolve().parent
BASE = HERE.parent.parent
REPO = BASE / 'integration'
REVISION = '7b8a3dbb90f191ee5520705a8233409274d9d752'
MANIFEST = HERE / 'source-manifest-7b8a3dbb.json'
MANIFEST_SHA = '68fb25de1082628814008f8e2325b2bdd0baa30d22a1f1db27f791c1b87a7312'
LOG = BASE / 'evidence/completion-checkpoint25-workspace-20260922.log'
...
def main():
    ...
    receipt = {
        ...
        'scope': 'Checkpoint25 regression validation only; A1 remains pending, no campaign certification claim.',
    ...
    path = HERE / 'build-receipt-7b8a3dbb.json'
