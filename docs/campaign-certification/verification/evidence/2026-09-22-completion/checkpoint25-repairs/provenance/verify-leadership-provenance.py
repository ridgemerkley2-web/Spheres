...
INPUTS += ['spheres-sim/src/stratagems/tests.rs', 'spheres-web/src/main.rs']
...
result = {'revision': git('rev-parse', 'HEAD'), 'python': sys.version, 'scope': 'Checkpoint25 test-fixture repairs over the selected fiscal and political model; metadata coherence only, not campaign certification or expanded historical coverage.', 'government_crlf_pairs_removed': raw.count(b'\r\n'), 'government_file_written': government_normalized, 'commands': [],
