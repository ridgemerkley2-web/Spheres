...
INPUTS += ['spheres-web/src/main.rs', 'spheres-sim/src/stratagems/tests.rs']
...
result = {'revision': git('rev-parse', 'HEAD'), 'python': sys.version, 'scope': 'Checkpoint26 fresh-only Army enrollment and fresh-browser source-state initialization provenance; metadata coherence only, not campaign certification or expanded historical coverage.', 'government_crlf_pairs_removed': raw.count(b'\r\n'), 'government_file_written': government_normalized, 'commands': [],
