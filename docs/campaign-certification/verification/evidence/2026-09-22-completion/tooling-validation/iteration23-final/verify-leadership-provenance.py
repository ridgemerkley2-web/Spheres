...
result = {'revision': git('rev-parse', 'HEAD'), 'python': sys.version, 'scope': 'Final iteration23 fiscal-accounting and selected political-source provenance after measured pins settle; metadata coherence only, not campaign certification or expanded historical coverage.', 'government_crlf_pairs_removed': raw.count(b'\r\n'), 'government_file_written': government_normalized, 'commands': [],
