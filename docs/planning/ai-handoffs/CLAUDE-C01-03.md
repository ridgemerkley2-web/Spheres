# CLAUDE-C01-03 — Saudi Arabia's executive chronology 1990-2026
...
[Report](../../campaign-certification/C01/research/saudi-executive-chronology-03.md): SA-EXEC-01 to 08
...
`research/saudi-executive-chronology-03.md`; new `tools/avatars/test_saudi_executive_c01_03.py`.
...
- This record and a new `research/saudi-executive-chronology-03.md` under
...
python -X utf8 -m unittest discover -s tools/avatars -p "test_saudi_executive_c01_03.py"  # 8 pass
