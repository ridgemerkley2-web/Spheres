...
- [x] Integrate useful master workforce, industry and fiscal changes while preserving financial construction.
- [x] Population, workforce and GDP contributions are applied once; existing balances are not reopened or charged twice.
- [x] Map old project IDs and paid entitlements explicitly; publish before/after accounting fixtures.

Evidence: [S02 ownership, accounting and verification](campaign-certification/S02/README.md).
...
- [x] Resolve the two different companies.rs responsibilities explicitly; a textual merge is insufficient.
- [x] Company property stays separate from government holdings, held money and earned revenue.
- [x] Existing certification, incoming purchases, ammunition contracts and refit reservations survive migration without duplication.
...
- [x] Reconcile budget settlement, trade, transfers, supplier payments and refunds to actual cash/debt movements.
- [x] Keep annual authority, actual spending and future commitments visibly distinct.
- [x] A player can diagnose fiscal distress and see the recorded consequence of a corrective decision after reload.

Evidence: [S06 money, recovery and verification](campaign-certification/S06/README.md).
...
**Status:** Complete · **Requires:** S05, S03

**Completion marker:** Research choices show which legal model choices unlock and why the player might want them.

- [x] Recommend legal affordable/advanced builds from actually researched components.
- [x] Compare acquisition, development, upkeep and role effects before commissioning; estimates retain stated conditions.
- [x] Research unlocks parts but never upgrades existing holdings for free; drafts and exact revisions survive navigation and saving.

Evidence and recommendation funding limits: [S09 qualification](campaign-certification/S09/README.md).
...
that increment stopped before S11.

**S10.d complete:** deadline-ordered diplomatic replies, explicit review controls,
native sender/deadline context, conditional guarantee warnings, readable phone
controls and a bounded Japan discovery packet. The
[S10.d proof](campaign-certification/S10/d/README.md) records six authored native
preview/cancel paths, one confirmed reply, an ordinary France journey and exact
Save/Load/Continue comparisons. S10, C01 and G2 remain open; execution stopped
after S10.d, before S11.

**S10.e complete:** saved defense and trade commitments, current-condition
upkeep estimates from native billing, and call reviews with actual coalition
and posture changes. The [S10.e proof](campaign-certification/S10/e/README.md)
records the bounded authored review/confirmation/save journey and one ordinary
subsequent day compared with an independently advanced native world. The call's
test setup does not establish historical opening obligations or multi-year
campaign behavior. India adds a partial recognition-row discovery packet.
...
**S10.g complete:** the diplomacy desk distinguishes sanctions imposed by your
government from sanctions against it. Reviews retain reverse restrictions,
actual freight conditions and later treaty consequences, and show the full
cost when a capped relationship cannot improve. The [S10.g proof](campaign-certification/S10/g/README.md)
records an authored France journey with three confirmed reviewed orders and
exact Save/Load/Continue comparisons. The browser journeys advance zero days;
a separate native preview benchmark qualifies the open-route review path only.
Tonga adds one bounded organization observation and dated role evidence, kept
separate from prime-minister appointment and continuous office terms. S10 and
C01 remain in progress, G2 is unearned, and S11 remains planned. Execution
stopped after S10.g.

**S10.h complete:** the political research atlas makes country observations,
separate offices, sources and unresolved gaps searchable. South Africa, Russia
and USSR bring partial discovery packets to all nine certification identity IDs.
[The S10.h report](campaign-certification/S10/h/README.md) records the exact
content and interface checks plus a read-only browser journey. No game runtime,
role grants or artwork changed. Exhaustive country censuses remain open; S10
...
**Status:** Complete · **Requires:** S15, S09

**Completion marker:** G3: Defend skies works with a researched, company-supplied fighter platform.

- [x] The fighter has legal component research, development, purchase, delivery, upkeep and stores.
- [x] Interception changes a hostile strike's result; fighter and ground-air-defense contributions remain distinct and coordinated.
- [x] A target aircraft cannot be destroyed twice, and depleted defense visibly loses effectiveness.

**Evidence and gate decision:** [S16 fighter and defensive aviation qualification](campaign-certification/S16/README.md). **G3 earned** with the exact inherited G2 and S11–S15 evidence. S17 and CP1 remain open.
