...
## Done (v0.5 rebuild)
- Deterministic core, save/load, 16 nations, monthly ticks
...
3. **Tech eras**: internet boom (~1995+ TFP for open economies), mobile, AI era;
   tech leader/laggard dynamics
4. **Peace deals**: negotiated ends (ceasefire, territorial concession) instead of
   only white peace / total victory
5. **Play mode polish**: event pause ("Iraq invaded Kuwait — respond?"), advisors,
   difficulty via GameRules
6. **Financial system**: currencies/FX, contagion (Asia 1997 should be emergeable)
7. Later: hourly-cadence scheduler, WASM/browser UI, multiplayer spheres
