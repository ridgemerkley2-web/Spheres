...
purpose-based project choices and effects reviews, shared building/mine
construction assignments, physical installation inputs, office output, separate
naval slots, advanced component production/trade, constrained facility operation,
and one inherited/new industry view. The standard industrial starter queues four
ordinary projects. Browser play enables this rule while legacy calibration
remains opt-out. This integrates the map/art and funded economy/equipment changes;
the company procurement direction below remains planned work.
...
Specialist-company contracts have since been integrated with the construction
and industry rebuild; see [COMPANIES.md](COMPANIES.md). Their bonuses and fees
follow real funded work. The separate company-owned inventory and procurement
direction above remains planned work.
